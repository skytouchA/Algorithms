...
public final class StdStats {
   ...
   /**
    ...
    public static void plotPoints(double[] a) {
        validateNotNull(a);
        int n = a.length;
        edu.princeton.cs.introcs.StdDraw.setXscale(-1, n);
        edu.princeton.cs.introcs.StdDraw.setPenRadius(1.0 / (3.0 * n));
        for (int i = 0; i < n; i++) {
            edu.princeton.cs.introcs.StdDraw.point(i, a[i]);
        }
    }
   ...
   /**
    ...
    public static void plotLines(double[] a) {
        ...
        for (int i = 1; i < n; i++) {
            edu.princeton.cs.introcs.StdDraw.line(i-1, a[i-1], i, a[i]);
        }
    }
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        edu.princeton.cs.introcs.StdOut.printf("       min %10.3f\n", min(a));
        edu.princeton.cs.introcs.StdOut.printf("      mean %10.3f\n", mean(a));
        edu.princeton.cs.introcs.StdOut.printf("       max %10.3f\n", max(a));
        edu.princeton.cs.introcs.StdOut.printf("    stddev %10.3f\n", stddev(a));
        edu.princeton.cs.introcs.StdOut.printf("       var %10.3f\n", var(a));
        edu.princeton.cs.introcs.StdOut.printf("   stddevp %10.3f\n", stddevp(a));
